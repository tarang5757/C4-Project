...
const Section = ({ heading, numCards }) => (
  <div className="bg-peach px-6 py-10 text-black min-h-screen flex flex-col items-center">
    ...
    <div className="flex flex-wrap justify-center gap-6 max-w-6xl mb-6">
...
const App = () => {
  ...
  return (
    <div>
      <div className="p-4">
        <h2 className="text-2xl mb-4">Enter Section Heading and Number of Cards</h2>
        <input
          type="text"
      ...
      <Section heading={heading || "Partner"} numCards={numCards} />
    </div>
  );
};
