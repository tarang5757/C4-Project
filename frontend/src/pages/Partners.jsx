...
const Partners = () => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-10 px-4 bg-gray-50"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div class="flex justify-center mt-10 items-center"><button class="bg-[#FFC709] text-food-black-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg text-lg text-black">Join Our Mission</button></div>
        </div>
  ...
  <div class="max-w-4xl mx-auto">
    <div class="text-center mb-10">
      <h2 class="text-4xl font-bold text-gray-900 mb-4">What Our Partners Say</h2>
    ...
    <div class="grid md:grid-cols-2 gap-8">
      ...
      <div class="bg-gray-50 rounded-lg p-8">
        <div class="flex items-center space-x-4 mb-4">
          <div class="w-16 h-16 bg-[#4CAF50] rounded-full flex items-center justify-center text-white text-2xl font-bold">FF</div>
          <div>
            <h3 class="text-xl font-semibold text-gray-900">Farm Fresh Co.</h3>
            <p class="text-[#4CAF50]">Local Farm</p>
          </div>
        </div>
        <p class="text-gray-600 leading-relaxed italic">
          "We used to feel bad about having to throw away extra produce. Now, thanks to this network, we can share our food with people who really need it. It's made such a difference in our community!"
        </p>
      </div>
      ...
      <div class="bg-gray-50 rounded-lg p-8">
        <div class="flex items-center space-x-4 mb-4">
          <div class="w-16 h-16 bg-[#4CAF50] rounded-full flex items-center justify-center text-white text-2xl font-bold">CF</div>
          <div>
            <h3 class="text-xl font-semibold text-gray-900">Community Food Bank</h3>
            <p class="text-[#4CAF50]">Food Bank</p>
          </div>
        </div>
        <p class="text-gray-600 leading-relaxed italic">
          "Getting fresh, local food has been a game-changer for us. The people we serve love the quality, and we love being able to support our local farmers. It's a win-win for everyone!"
        </p>
      </div>
